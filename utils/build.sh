...
echo "Build CV page"
pandoc ../sections/curriculumVitae/cv.md -f markdown -t html --template=../template/cv_page.html --defaults=../defaults/cv.yaml --highlight-style=breezedark --output ../CV.html
